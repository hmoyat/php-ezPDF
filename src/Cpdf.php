<?php
@include_once __DIR__ . '/include/TTFsubset.php';
...
class Cpdf
{
     ...
     * @var string
     * @todo Nasty solution to make it work for now.... (Humberto Moya)
     */
    public $tempPath = '/public/tmp';
    /**
    ...
    protected function openFont($font)
    {
        ...
        $fp = fopen(getcwd() . "/" . $this->tempPath . '/' . $cachedFile, 'w'); // use the temp folder to write cached font data
